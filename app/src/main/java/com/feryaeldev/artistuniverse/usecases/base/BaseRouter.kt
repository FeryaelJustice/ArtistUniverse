package com.feryaeldev.artistuniverse.usecases.base
...
interface BaseFragmentRouter {
    ...
    fun add(manager: FragmentManager, containerId: Int, tag: String) =
        manager.beginTransaction().add(containerId, fragment(), tag)

    fun replace(manager: FragmentManager, containerId: Int) =
